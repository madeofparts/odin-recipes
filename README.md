# odin-recipes
## The Odin Project -- Assignment 1 for Foundations

This project is just a basic HTML page with a recipe.
This will demonstrates:
- usage of basic textual elements (headings, paragraphs, lists)
